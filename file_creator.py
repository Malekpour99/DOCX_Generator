...
def generate_filename(row_data, index):
    ...
    customer_name = str(row_data.get('نام گیرنده', f'customer_{index}')).replace(' ', '_')
...
def check_dependencies():
    ...
    required_packages = ['pandas', 'python-docx']
    missing_packages = []
...
if __name__ == "__main__":
    print("=== CSV to DOCX Generator (Template Structure Preserved) ===")
    print("This script will process the CSV file and generate DOCX documents")
    print("while preserving the original template structure and formatting.")
    print()
